...
#                 ('BINID_INDEX',int),
#                 ('REDSHIFT', float),
#                 ('MASK', bool if bitmask is None else bitmask.minimum_dtype(), (nindx,)),
#                 ('BCEN', float, (nindx,)),
#                 ('BCONT', float, (nindx,)),
#                 ('BCONT_ERR', float, (nindx,)),
#                 ('BCONT_MOD', float, (nindx,)),
#                 ('BCONT_CORR', float, (nindx,)),
#                 ('RCEN', float, (nindx,)),
#                 ('RCONT', float, (nindx,)),
#                 ('RCONT_ERR', float, (nindx,)),
#                 ('RCONT_MOD', float, (nindx,)),
#                 ('RCONT_CORR', float, (nindx,)),
#                 ('MCONT', float, (nindx,)),
#                 ('MCONT_ERR', float, (nindx,)),
#                 ('MCONT_MOD', float, (nindx,)),
#                 ('MCONT_CORR', float, (nindx,)),
#                 ('AWGT', float, (nindx,)),
#                 ('AWGT_ERR', float, (nindx,)),
#                 ('AWGT_MOD', float, (nindx,)),
#                 ('AWGT_CORR', float, (nindx,)),
#                 ('INDX', float, (nindx,)),
#                 ('INDX_ERR', float, (nindx,)),
#                 ('INDX_MOD', float, (nindx,)),
#                 ('INDX_CORR', float, (nindx,)),
#                 ('INDX_BF', float, (nindx,)),
#                 ('INDX_BF_ERR', float, (nindx,)),
#                 ('INDX_BF_MOD', float, (nindx,)),
#                 ('INDX_BF_CORR', float, (nindx,))
#               ]

...
class CubeData:
    ...
    def __init__(self, galname=None, bin_key=None, plate=None, ifu=None):
        ...
        mangadap_muse_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
        ...
        output_beta_dir = os.path.join(output_gal_dir, 'beta_plots_old')
    ...
    def create_beta_tables(self, verbose=False):
        ...
        for wv_key in wv_dict.keys():
            ...
            beta_tables_dir = os.path.join(os.path.join(os.path.dirname(os.path.abspath(__file__))), 'beta_tables')
